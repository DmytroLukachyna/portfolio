const translationDB = {
  en: {
    ...
    profile2:
      'I like to look for interesting solutions for accomplishing tasks I am facing and, together with my ideas, implement them in the form of websites. In addition, I am constantly developing in this sphere, since perfection knows no limits :)',
    profile3:
      'Validity of the code, complete adaptability of the content, the accuracy and readability of the layout as well as the use of the most relevant cutting-edge technologies are crucial cornerstones of my work.',
    ...
    workdescr1:
      "Translated more than 30 ECtHR judgements, 10+ Venice Commission's opinions as well as hundreds of Council of Europe experts' conclusions, recommendations and declarations;",
    workdescr2:
      'Contributed to translation and proofreading of translation of 40+ laws of Ukraine incl. those amending the Constitution of Ukraine;',
    workdescr3:
      'Consulted and gave recommendations to translators on usage of different CAT-tools (incl. technical questions and troubleshooting of issues).',
  ...
  uk: {
    ...
    profile2:
      'Мені подобається шукати цікаві рішення для виконання завдань, поставлених переді мною, і разом із моїми ідеями реалізовувати їх як сайти. Окрім того, я постійно розвиваюся у цій сфері, адже досконалості немає меж :)',
    profile3:
      'У процесі веб-розробки головне для мене – валідність коду, повна адаптивність контенту, акуратність та читабельність верстки, а також застосування найновіших та найактуальніших технологій.',
    ...
    certificatesdescr2:
      '(натисніть на сертифікат для того, щоб перейти на його оригінальну версію)',
    workstudytitle: 'Кар’єрний шлях',
    workstudywork: 'Досвід роботи',
    workdate1: '08/2015 - донині',
    worktitle1: 'Перекладач',
    workdescr1:
      'Переклав понад 30 рішень ЄСПЛ, 10+ висновків Венеціанської комісії, а також сотні висновків, рекомендацій та заяв експертів Ради Європи;',
    workdescr2:
      'Залучався до перекладу та редагування перекладу понад 40 законів України, у т.ч. тих, що передбачали внесення змін до Конституції України;',
    workdescr3:
      "Консультував та надавав рекомендації перекладачам щодо використання різних CAT-інструментів (зокрема стосовно технічних питань та розв'язання проблем).",
  ...
  ru: {
    ...
    profile2:
      'Мне нравится искать интересные решения для выполнения стоящих передо мной задач и вместе с моими идеями реализовывать их в виде сайтов. Кроме того, я постоянно развиваюсь в этой сфере, так как совершенству нет предела :)',
    profile3:
      'В процессе веб-разработки главное для меня – валидность кода, полная адаптивность контента, аккуратность и читаемость верстки, а также применение самых новых и актуальных технологий.',
    ...
    certificatesdescr2:
      '(Нажмите на сертификат для того, чтобы перейти на его оригинальную версию)',
    workstudytitle: 'Карьерный путь',
    workstudywork: 'Опыт работы',
    workdate1: '08/2015 - по сей день',
    worktitle1: 'Переводчик',
    workdescr1:
      'Перевел более 30 решений ЕСПЧ, 10+ выводов Венецианской комиссии, а также сотни выводов, рекомендаций и заявлений экспертов Совета Европы;',
    workdescr2:
      'Участвовал в переводе и редактировании перевода более 40 законов Украины, в т.ч. предусматривающих внесение изменений в Конституцию Украины;',
    workdescr3:
      'Консультировал и предоставлял рекомендации переводчикам в части использования различных CAT-инструментов (в частности касательно технических вопросов и решения проблем).',
